...
#define STAGE1_FLYING_ENEMY_BULLET_SOUND ASSETS_PATH("/audio/Sounds/3. Inimigo Aereo/AtirandoFogo.wav")
...
#define STAGE1_BOSS_DOWN_ATTACK_ANIMATION ASSETS_PATH("/img/Frog/LinguaParaBaixo.png")
#define STAGE1_BOSS_UP_ATTACK_ANIMATION ASSETS_PATH("/img/Frog/LinguaParaCima.png")
